...
public class Vector2D {
    ...
    public double getAngle(Vector2D vector_2) { // ToDo: angle class?? Also make sure vectors are tail-to-tail
        Vector2D this_vector = new Vector2D(x, y); // todo: any way to refer to this vector directly?
